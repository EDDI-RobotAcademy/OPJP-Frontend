    ...
    <v-container>
        <v-row v-if="!isAuthenticated">
            <v-col cols="12">
                <v-card outlined class="mb-6 pa-4">
                    <h2 class="text-h6 orange--text">OPJP 멤버에게 제공되는 무료 배송 서비스</h2>
                    <p class="text-body-2 mb-0">
                        OPJP 멤버가 되어 무료배송 서비스를 비롯한 다양한 혜택을 누려보세요.
        ...
        <v-row>
            ...
            <v-col cols="12" md="4">
                <v-card outlined class="pa-4">
                    ...
                    <div class="d-flex justify-space-between text-h6 font-weight mt-4">
                        <span>총 결제 금액</span>
        ...
        <v-dialog v-model="isCheckoutDialogVisible" max-width="500">
            <v-card>
                ...
                <v-card-text> 선택한 도서를 주문하시겠습니까? </v-card-text>
                <v-card-actions>
                    <v-spacer></v-spacer>
...
export default {
    ...
    methods: {
        ...
        getProductImage(bookName) {
            return require(`@/assets/images/uploadImages/${bookName}.png`);
        },
        ...
        async fetchCartList() {
            try {
                const response = await this.requestCarListToDjango();
