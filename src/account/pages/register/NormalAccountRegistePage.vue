<template>
    <v-container class="register-container" fill-heigh>
...
export default {
    ...
    computed: {
        isValidForSubmission() {
            return this.formValid && this.isNicknameVaid && this.age !== 0;
        },
    },
    methods: {
        ...
        async checkNicknameDuplication() {
            ...
            try {
                ...
                if (isDuplicate) {
                    this.nicknameErrorMessage = ["이 nickname은 이미 사용중입니다!"];
                    this.isNicknameVaid = false;
                } else {
                    this.nicknameErrorMessage = [];
                    this.isNicknameVaid = true;
                }
            } catch(error) {
