    ...
    <v-container>
        ...
        <v-dialog v-model="dialog" max-width="500">
            <v-card>
                ...
                <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn color="green darken-1" text @click="colorDialog">확인인</v-btn>
                </v-card-actions>
            </v-card>
        </v-dialog>
    </v-container>
