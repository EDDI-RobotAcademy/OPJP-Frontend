<template>
    <div class="analysis-container">
        ...
        <div class="button-group">
            ...
            <button @click="getForcecastData" class="btn btn-forecast">
                <i class="fas fa-char-line"></i> 구매동향 그래프 그리기
            </button>
        </div>
...
export default {
    ...
    methods: {
        ...
        createChart() {
            ...
            this.svgHeigth = chartContainer.clientHeight;
            ...
            const y = d3
                ...
                .range([this.svgHeigth - this.margin.top - this.margin.bottom, 0]);

            g.append("g")
                .attr(
                    "transform",
                    `translate(0, ${this.svgHeigth - this.margin.top - this.margin.bottom})`
                )
        ...
        handleResize() {
            ...
            this.resizeTimer = setTimeout(() => {
                ...
                d3.select(this.$refs.svg).attr(
                    "viewBox",
                    `0 0 ${this.svgWidth} ${this.svgHeigth}`
                );
