...
export default {
    ...
    methods: {
        ...
        async trainModel() {
            // const data = JSON.parse(JSON.stringify(this.form));  // Convert Proxy to regulart object
        ...
        async executePostRequest(url, data = {}, resultKey = null, successMessage = null) {
            ...
            this.loading = true;
            try {
                const response = await fastapiAxiosInst.fastapiAxiosInst.post(url, data, {
                    timeout: 60000,
                });
